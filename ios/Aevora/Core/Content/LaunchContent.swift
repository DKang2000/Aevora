...
struct LaunchContent: Codable {
    ...
    static var fallback: LaunchContent {
        let fallbackData = Data("""
        {
          ...
          "npcs":[{"id":"tovan_hearth","displayNameKey":"content.npc.tovan_hearth.name","summaryKey":"content.npc.tovan_hearth.summary","districtId":"ember_quay","dialogueSetKey":"content.dialogue.tovan_hearth","role":"baker"}],
          ...
          "itemDefinitions":[{"id":"ember_quay_token","nameKey":"content.item.ember_quay_token.name","bucket":"reward_token","rarity":"uncommon"}],
          "shopOffers":[]
        }
        """.utf8)
